...
/* harmony import */ var _model_CoreInput__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ../model/CoreInput */ "./app/model/CoreInput.js");
  ...
  addComponent(component) {
    ...
    this.appLocationElement.addEventListener("click", e => {
      ...
      if (btn) {
        ...
        component.model.coreInputs.push(new _model_CoreInput__WEBPACK_IMPORTED_MODULE_0__["default"]()); // WHY THE TRAP IS NOT TRIGGERED!?11? /* 29.07: it finally is triggered 🤪🙃  */
        // this.updateView();
      }
    });
  }
...
class Router {
    constructor(app) {
        ...
        window.addEventListener('hashchange', this.switchComponent);
        window.addEventListener('DOMContentLoaded', this.switchComponent);
    }
...
/* harmony import */ var _lib_app__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./lib/app */ "./app/lib/app.js");
/* harmony import */ var _lib_router__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./lib/router */ "./app/lib/router.js");
/* harmony import */ var _components_Builder__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ../components/Builder */ "./components/Builder.js");
/* harmony import */ var _model_CoreInput__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./model/CoreInput */ "./app/model/CoreInput.js");
...
const app = new _lib_app__WEBPACK_IMPORTED_MODULE_1__["default"]('.app');

const router = new _lib_router__WEBPACK_IMPORTED_MODULE_2__["default"](app);

const builderComponent = new _components_Builder__WEBPACK_IMPORTED_MODULE_3__["default"]();

// app.addComponent(builderComponent);

app.addComponent(new _components_Builder__WEBPACK_IMPORTED_MODULE_3__["default"]());
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "default", function() { return CoreInput; });
/* harmony import */ var _util_sequentialNumberGenerator__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ../util/sequentialNumberGenerator */ "./app/util/sequentialNumberGenerator.js");
...
class CoreInput {
    constructor() {
        this.subInput = [];
        this.idGen = Object(_util_sequentialNumberGenerator__WEBPACK_IMPORTED_MODULE_0__["default"])();
    }
...
/***/ "./app/util/sequentialNumberGenerator.js":
/*!***********************************************!*\
  !*** ./app/util/sequentialNumberGenerator.js ***!
  \***********************************************/
/*! exports provided: default */
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "default", function() { return seqNumGen; });
function* seqNumGen() {
    let counter = 1;
    while (true) {
        yield counter++;
    ...
    return `
        <div class="builder">
            <div class="big-black-box">
                <h1> ${this.model.coreInputs.length} thismodel</h1>
                </div>
        </div>
...
/***/ 0:
/*!******************************************!*\
  !*** multi babel-polyfill ./app/main.js ***!
  \******************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {
